...
import 'logscreenstep_tab1_page.dart';
...
class LogScreenStep3PositiveScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => LogScreenStep3PositiveProvider(),
      child: LogScreenStep3PositiveScreen(),
    );
  }
}

class LogScreenStep3PositiveScreenState
    extends State<LogScreenStep3PositiveScreen> with TickerProviderStateMixin {
              ...
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    controller: tabviewController,
                    children: [
                      LogscreenstepTab1Page.builder(context),
                      LogScreenStep3NoNegativePage.builder(context),
                    ],
                  ),
                ),
              ],
  ...
  PreferredSizeWidget _buildAppbar(BuildContext context) {
    return CustomAppBar(
      ...
      leading: AppbarLeadingIconbutton(
        ...
        margin: EdgeInsets.only(left: 16.h, top: 9.h, bottom: 9.h),
        onTap: () {
      ...
      title: SliderTheme(
        data: SliderThemeData(
          ...
          activeTrackColor: theme.colorScheme.onPrimary.withValues(alpha: 0.6),
