  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          backgroundColor: Color(0xFFD78F5D),
          extendBody: true,
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        width: 300.h,
                        child: Text(
                          "You don't always need to feel something big.\nJust being here matters.",
