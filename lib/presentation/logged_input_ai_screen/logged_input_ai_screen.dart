...
class LoggedInputAiScreen extends StatefulWidget {
  ...
  @override
  LoggedInputAiScreenState createState() => LoggedInputAiScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => LoggedInputAiProvider(),
      child: LoggedInputAiScreen(),
    );
  }
}

class LoggedInputAiScreenState extends State<LoggedInputAiScreen> {
  @override
  void initState() {
    super.initState();
  }
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    Selector<LoggedInputAiProvider, TextEditingController?>(
                      ...
                      builder: (context, miconeController, child) {
                        return CustomTextFormField(
                          ...
                          contentPadding:
                              EdgeInsets.symmetric(vertical: (106).h),
  ...
  Widget _buildChatmessagelist(BuildContext context) {
    return Container(
      ...
      width: double.maxFinite,
      child: Consumer<LoggedInputAiProvider>(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: CustomTextStyles
                                      .labelLargeRobotoSecondaryContainerMedium
                                      .copyWith(
